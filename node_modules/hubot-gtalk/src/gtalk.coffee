...
class Gtalkbot extends Adapter
  run: ->
    ...
    @options =
      ...
      #password: 'yyyyyyyxxxxxx'
      username: 'robotblabla@gmail.com'
      password: 'robotblabla@)13'
      ...
      port: 5222
      keepaliveInterval: 150000 # ms interval to send query to gtalk server
  ...
  getUser: (jid) ->
    # 在这里获得user, 比如user的room属性, 通过userForId 传options给src中的user.coffee, 最后在robot对象中才能获得到room属性
    # console.log  22222222222, jid
